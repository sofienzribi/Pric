...
@SessionScoped
public class CopyOfLoginBean extends HttpServlet implements Serializable {

	@ManagedProperty("#{applicationbean.getList()}")
	private List<CopyOfLoginBean> list;
	...
	public List<CopyOfLoginBean> getList() {
		return list;
	}

	public void setList(List<CopyOfLoginBean> list) {
		this.list = list;
	}
